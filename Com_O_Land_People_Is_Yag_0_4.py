...
Dialog_kla = ["บังกล้าชะล่าใจ : ยินดีต้อนรับเข้าสู่อณาจักรแห่งคอมโอที่มีแต่พวก yag!" , "บังกล้าชะล่าใจ : เอ้ย! ไม่ใช่ที่นี่มีแต่สุภาพชนที่พร้อมจะพูดคำว่า \"คุณ\" กับ \"Kub\" " , 'บังกล้าชะล่าใจ : คุณอาจจะยังไม่ชินกับอณาจักรคอมโอแห่งนี้ใช่มั้ย ณ Kub?' , 'บังกล้าชะล่าใจ : ยังไงก็เถอะผมคิดว่าคุณจะสามารถตามหาความฝันได้ แม้ว่าคุณจะไม่ได้ผู้แทนศูนย์แต่ผมก็เชื่อว่าความพยายามไม่่เคยทำร้ายใคร ณ​ Kub' , 'บังกล้าชะล่าใจ : ที่ผมพูดมาเมื่อกี้ช่างมันเถอะ ณ Kub พอดีผมผ่านอะไรมาเยอะไปหน่อย มันมึนมึน' , "บังกล้าชะล่าใจ : ผมรู้ว่ามันอาจจะยากที่""คุณ""จะเริ่มต้นใหม่กับคนเดิมถึงแม้คุณจะอยากแค่ไหนก็ตาม เอ้ย!เริ่มต้นใหม่ที่อณาจักรแห่งนี้ต่างหากขอให้คุณโชคดีkub"]
DKL = len(Dialog_kla)
...
def title_screen_selections():
    ...
    while True :
        if option.lower() == '1':
            ...
            print(" ""คุณ""สามารถพิมพ์ได้แค่เลข 1 , 2 และ 0 เท่านั้น Kub")
            option = input('>: ')
...
def help_menu():
    ...
    if(dialogue == 1) :
        print("""ก.กล้าการช่าง : ผมไม่มีอะไรจะช่วยคุณทั้งนั้นแหละ Kub ขอให้คุณโชคดีมีชัยโชคชัยมีวัว""")
    if(dialogue == 2) :
        print("""ก.กล้าการช่าง : คนที่แพ้ก็ต้องดูแลตัวเองนะ Kub""")
    if(dialogue == 3) :
        print("""ก.กล้าการช่าง : สำหรับคุณแล้วคนแบบผมก็คงเป็นแค่ตัวตลกใช่มั้ย""")
    if(dialogue == 4) :
        print("""ก.กล้าการช่าง : อยากจะบอกรักเธอแบบ Y2K""")
    if(dialogue == 5) :
        print("""ก.กล้าการช่าง : ผมไม่ yag ณ Kub""")
    if(dialogue == 6) :
        print("""ก.กล้าการช่าง : มาสิมามาทำ Competitive Programming กันน!!!""")
    if(dialogue == 7) :
        print("""ก.กล้าการช่าง : โลกคอมโอมันโหดร้าย เพราะมีเด็ก ม.2 ที่เทพมาจากไหนไม่รู้""")
    if(dialogue == 8) :
        print("""ก.กล้าการช่าง : ระวังตัวไว้ให้ดีระวังจะเจอหมิกแอดฮอกนะ (นิยามคำว่าหมิกก็คือ dynamic programming ที่เรารู้จักกันทั่วไปนั่นเอง)""")
    if(dialogue == 9) :
        print("""ก.กล้าการช่าง : พวกคุณทุกคนน่ะ yag กันหมดนั่นแหละ!!!""")
    if(dialogue == 10) :
        print("""ก.กล้าการช่าง : เจ็บตัวยังพอทน...แต่เจ็บใจสิแย่ (อรั๊ย)""")
    title_screen_selections()
...
def setup_game():
    ...
    os.system('clear')
    cnt = 1
    for i in range (0 , DKL) :
        print(Welcome)
        for j in range(0 , cnt) :
            print(Dialog_kla[j])
        input('\nบังกล้าชะล่าใจ : กด enter เถอะผมอยากพูดต่อแล้ว ณ​ Kub')
        cnt += 1
        os.system('clear')
    print('ผมลืมถามเลยคุณชื่ออะไร ณ คับ?\n')

    name = input('ชื่อของคุณ >: ')

# เผ่า #
    os.system('clear')
    print('บังกล้าชะล่าใจ : คุณอยากเป็นเผ่าพันธุ์อะไร ณ Kub?\n')
    print('1 มนุษย์ธรรมดา\n2 Bruteforce ตึง ตึง\n3 เหล่าคนบ้าโจทย์\n4 เขียนโปรแกรมได้หลายภาษา\n5 นับถือพรี่ไอซ์\n6 เขียนโค้ดไม่ได้\n7 เน้น Algorithm\n')
    selection = input('>: ')
    while True :
        if selection == '1':
            race = "มนุษย์ธรรมดา"
            ...
            print("บังกล้าชะล่าใจ : ผมก็บอกอยู่ว่าให้""คุณ""ใส่แค่เลข 1 - 7 ทำไม ""คุณ""ถึงดื้อได้ขนาดนี้ kub")
            selection = input('>: ')

    os.system('clear')

# Occupation #
    print('บังกล้าชะล่าใจ : ความชำนาญในสายอาชีพของคุณคืออะไร ณ Kub\n')
    print("""1 นักตะลุยโจทย์
2 Competitive Programming
3 Bruteforce Enjoyer
4 Dynamic Programming Lover
5 Binary Search Lover
7 Software Developer
8 Project Manager
9 Database Administrator
10 Machine Learning Engineer
11 Graph Theory Expert
12 Data Science Analyst
13 Machine Learning Engineer
14 Blockchain Developer
15 Artificial Intelligence Researcher
             """)
    selection = input('>: ')
    while True :
        if selection == '1':
            occupation = 'นักตะลุยโจทย์'
            hp = hp + 10
            max_hp = max_hp + 10
            food = food + 50
            ...
            occupation = 'Competitive Programmin'
            hp = hp + 100
            max_hp = max_hp + 100
            food = food + 25
            ...
            occupation = 'Dynamic Programming Lover'
            hp = hp + 0
            max_hp = max_hp + 0
            food = food + 25
            max_food = max_food + 100
            ...
            max_food = max_food + 150
            arrows = arrows + 0
            max_arrows = max_arrows + 50
            gold = gold + 250
            max_gold = max_gold + 800
            martial_prowess = martial_prowess + 5
            break
        elif selection == '7':
            ...
            max_hp = max_hp + 50
            food = food + 100
            max_food = max_food + 200
            arrows = arrows + 0
            max_arrows = max_arrows + 5
            gold = gold + 800
            max_gold = max_gold + 2000
            martial_prowess = martial_prowess + 10
            break
        elif selection == '11':
            occupation = 'Graph Theory Expert'
            hp = hp + 50
            max_hp = max_hp + 50
            food = food + 50
            max_food = max_food + 150
            arrows = arrows + 20
            max_arrows = max_arrows + 30
            gold = gold + 150
            max_gold = max_gold + 1000
            martial_prowess = martial_prowess + 30
            break
        elif selection == '12':
            ...
            gold = gold + 800
            max_gold = max_gold + 2000
            martial_prowess = martial_prowess + 40
            break
    ...
    print('บังกล้าชะล่าใจ : อาวุทลับ ทีเด็ด พลังแฝงของคุณคืออะไร ณ Kub')

    weapon = input('>: ')
    gold_mechanic()
    os.system('clear')
    print('บังกล้าชะล่าใจ : โอ้ต่อจากนี้คุณคือ ' + name + ', ที่อยู่เผ่า ' + race + ' และ มีอาชีพเป็น ' + occupation + ' ซึ่งมีอาวุลับ และ ทีเด็ดคือ ' + weapon + '\n')
    print('\n')
    print('############################################\n')
    print('ชื่อ : ' + name + '')
    print('เผ่า : ' + race + '')
    print('อาชีพ : ' + occupation + '\n')
    print('############################################\n')
    print('หัวจาย : ' + str(hp) + '/' + str(max_hp) + '')
    print('ความชำนาญ : ' + str(martial_prowess) + '')
    print('อาวุทลับ : ' + weapon + '\n')
    print('############################################\n')
    print('อัตราการใช้ : ' + str(consumption_rate) + '')
    print('อาหาร : ' + str(food) + '/' + str(max_food) + '')
    print('ความอดทน : ' + str(endurance) + '')
    print('Arrows: ' + str(arrows) + '/' + str(max_arrows) + '\n')
    print('############################################\n')
    print('เงิน : ' + str(gold) + '/' + str(max_gold) + '\n')
    print('############################################\n')
    print('\n')
    selection = input('ไอกล้าพลาดผู้แทน : กด enter สิโว้ย')
...
def hp_mechanic():
    ...
    if hp > max_hp:
        hp = max_hp
        print('เห้ย! เลือดเต็มแล้ว Kub คุณ')
    if hp < 1:
        hp = 0
        death()
...
def food_mechanic():
    ...
    if food > max_food:
        food = max_food
        print('อาหารตาเต็มไปหมด! เอ้ยอาหารมีเต็มเลย ณ Kub คุณ')
    if food < 1:
        food = 0
